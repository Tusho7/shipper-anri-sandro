  ...
  return (
    <div className="bg-home h-screen bg-cover bg-no-repeat">
        ...
        <div className="flex flex-col items-center mt-[102px] text-7xl">
            <h1>Welcome To ShipCo</h1>
            <p className="text-3xl mt-20">Lorem ipsum dolor sit amet consectetur. Lobortis venenatis lorem nulla senectus felis sit enim facilisi vel.</p>
        </div>
