  ...
  return (
    <div className="w-screen h-screen bg-cover landingPageSection min-w-full	">
        ...
        <div className="flex flex-col items-center mt-[102px]  text-white">
            ...
            <p className="mt-12 text-center lg:w-[794px] text-md lg:text-3xl break-words font-light	">Lorem ipsum dolor sit amet consectetur. Lobortis venenatis lorem nulla senectus felis sit enim facilisi vel.</p>
        </div>
